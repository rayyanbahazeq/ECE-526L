...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I894;
    UB  * I895;
    struct _RmaMultiInputTable * I870;
    struct _RmaMultiInputTable * I897;
} RmaMultiInputTable;
...
typedef struct {
    U  I705;
    U  I713;
    RmaThreadSchedCompiledLoads  * I1002;
...
typedef struct {
    ...
    RP   I802[(4)];
    RP   I804[(4)];
    RemoteDbsedLoad   I1061[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I870;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I870;
    struct TableAssignLayoutOnClk_ * I789;
    U  I5;
    U  I1063 :1;
    U  I1064 :1;
    U  I1065 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I870;
    struct TableAssignLayoutOnClkOpt_ * I789;
    U  I5;
    U  I1063 :1;
    U  I1064 :1;
    U  I1065 :2;
    ...
    U  I368 :15;
    U  I1075;
    RmaSeqPrimOutputOnClkOpt  I1072;
    RmaSeqPrimOutputEblkData  I1076;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    UB  I1131;
    UB  I1139;
    RmaNonEdgeLoadData1  * I1048;
    RmaNonEdgeLoadData1  * I789;
    void * I1140;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1048;
    RmaChildClockProp  * I789;
...
struct futq_slot1 {
    U  I746;
    struct futq_slot2  I747[32];
};
struct futq_info {
    scalar  * I741;
    U  I742;
    U  I743;
    struct futq_slot1  I744[32];
};
struct futq {
    struct futq * I731;
    struct futq * I733;
...
struct dummyq_struct {
    ...
    struct futq * I1154;
    struct futq * I1155;
    struct sched_table * I1156;
    struct futq_info * I1158;
    struct futq_info * I1160;
    U  I1161;
    U  I1162;
    U  I1163;
    U  I1164;
    ...
    int I1221;
    int I1222;
    struct vcs_globals_t * I1223;
    clock_struct  I1224;
    unsigned long long I1225;
    EBLK  * I1226;
    EBLK  * I1227;
    void * I1228;
};
...
void  hs_0_M_11_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_12_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_13_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_14_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_15_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_16_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_17_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_18_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_19_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
...
void  hs_0_M_20_1__simv_daidir (UB  * pcode, scalar  val, U  I668, scalar  * I1270, U  did);
